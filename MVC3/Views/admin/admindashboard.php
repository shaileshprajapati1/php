			...
			<div class="main-page">
				...
				<div class="row">
					<div class="col-md-8 map widget-shadow">
						...
						<script src="<?php echo $this->baseURL ;?>assets/admin/js/jquery.vmap.js"></script>
						<script src="<?php echo $this->baseURL ;?>assets/admin/js/jquery.vmap.sampledata.js" type="text/javascript"></script>
						<script src="<?php echo $this->baseURL ;?>assets/admin/js/jquery.vmap.world.js" type="text/javascript"></script>

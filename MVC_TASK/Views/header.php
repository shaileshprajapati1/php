	...
	<div class="header-top-w3layouts">
		<div class="container">
			<div class="col-md-6 logo-w3">
				<a href="home"><img src="<?php echo $this->baseURL; ?>images/logo2.png" alt=" " />
					<h1>PRODUCT</h1>
				</a>
			</div>
	...
	<div class="header-bottom-w3ls">
		<div class="container">
									...
									<div class="row">
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												...
												<li><a href="mobile"><i class="fa fa-angle-right" aria-hidden="true"></i>Mobile</a></li>
												<li><a href="television"><i class="fa fa-angle-right" aria-hidden="true"></i>Television</a></li>
												<li><a href="audio"> <i class="fa fa-angle-right" aria-hidden="true"></i>Audio</a></li>
			...
			<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
				<ul class="nav navbar-nav ">
					<?php
					// print_r($_SESSION['userdata'][0]);
					if (isset($_SESSION['userdata'])) { ?>
						<h5> Hello <span><?php echo $_SESSION['userdata'][0]->name; ?></span> </h5>
				...
				<div class="col-md-1 cart-wthree">
					...
					<button class="w3view-cart" type="submit" name="add" value=""><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></button>
				</form>   -->
					</div>
				</div>
				<div class="clearfix"></div>

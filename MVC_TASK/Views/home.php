...
<!-- <div class="banner-bootom-w3-agileits">
	<div class="container">
		<div class="col-md-5 bb-grids bb-left-agileits-w3layouts">
			<a href="mobile"><div class="bb-left-agileits-w3layouts-inner">
					<h3>SALE</h3>
					<h4>upto<span>75%</span></h4>
			</div></a>
		</div>
		<div class="col-md-4 bb-grids bb-middle-agileits-w3layouts">
			<a href="television"><div class="bb-middle-top">
				<h3>SALE</h3>
				<h4>upto<span>55%</span></h4>
			</div></a>
			<a href="audio"><div class="bb-middle-bottom">
				<h3>SALE</h3>
		...
		<div class="sap_tabs">
			<div id="horizontalTab">
				<ul class="resp-tabs-list">
					...
					<li class="resp-tab-item"><span>All Product</span></li>
					<!-- <li class="resp-tab-item"><span>Television</span></li> -->
					<!-- <li class="resp-tab-item"><span>Audio</span></li> -->
					...
					<div class="tab-1 resp-tab-content">
						...
						foreach ($ViewallProductinhome['Data'] as $key => $value) { ?>
							...
							<div class="col-md-3 top-product-grids tp1 animated wow slideInUp" data-wow-delay=".5s">
								...
								<h5><?php echo $value->Price; ?> <span>Rs</span></h5>
							</div>
						<?php }
						?>
						...
						<div class="col-md-3 top-product-grids tp4">
							<a href="single.html">
								<div class="product-img">
									...
									<div class="p-mask">
										<form action="#" method="post">
											<input type="hidden" name="Title" value="_cart" />
											<input type="hidden" name="Price" value="1" />
											<input type="hidden" name="CategoryID" value="Casual shoes" />
...
<script src="<?php echo $this->baseURL; ?>js/easyResponsiveTabs.js" type="text/javascript"></script>
...
<div class="fandt">
	...
	<script src="<?php echo $this->baseURL; ?>js/jquery.wmuSlider.js"></script>
	<script>
		$('.example1').wmuSlider();
	</script>
</div>
...
<div class="top-brands">
	<div class="container">
		...
		<script type="text/javascript" src="<?php echo $this->baseURL; ?>js/jquery.flexisel.js"></script>
	</div>
</div>
<!-- //top-brands -->
<!-- newsletter -->
